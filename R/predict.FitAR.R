...
#' 
#' After fitting we predict at origin times n, n+1, ..., n+m, where m is the length 
#' of the vector newdata and for lead time series as specified by n.ahead.
#' 
#' @usage predict(object, n.ahead = 1, newdata = numeric(0), ...) ## S3 method for class 'FitAR'
#' @param object ‘FitAR’ object.
#' @param n.ahead lead time.
#' @param newdata new time series values.
#' @param ... optional arguments.
#' @details The prediction algorithm described in McLeod, Yu and Zinovi (2008) is used.
#' @returns
...
#' @author A.I. McLeod.
#' @references McLeod AI, Yu H, Zinovi K (2008). Linear Time Series Modeling 
#'   with R Package. Journal of Statistical Software, 23/5, 1-26.
#' @seealso [TrenchForecast()].
#' @examples
